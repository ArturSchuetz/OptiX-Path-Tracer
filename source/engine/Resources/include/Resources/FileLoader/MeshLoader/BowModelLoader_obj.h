...
namespace bow {
	...
	*/
	...
	private:
		...
		inline void parseReal2(float *x, float *y, const char **token, const float default_x = 0.0, const float default_y = 0.0);
		...
		inline void parseV(float *x, float *y, float *z, float *w, const char **token, const float default_x = 0.0, const float default_y = 0.0, const float default_z = 0.0, const float default_w = 1.0);
